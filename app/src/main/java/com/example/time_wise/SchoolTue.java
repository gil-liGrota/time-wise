...
public class SchoolTue extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lessonsList.isEmpty()) {
                    Toast.makeText(SchoolTue.this, "No lessons entered!", Toast.LENGTH_SHORT).show();
                    return;
                }

                String dayName = txtDayTitle.getText().toString();
                SchoolDay schoolDay = new SchoolDay("Tuesday", lessonsList);
                ...
                Intent intent = new Intent(SchoolTue.this, SchoolWed.class);
