...
public class SchoolFriday extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lessonsList.isEmpty()) {
                    Toast.makeText(SchoolFriday.this, "No lessons entered!", Toast.LENGTH_SHORT).show();
                    return;
                }

                String dayName = txtDayTitle.getText().toString();
                SchoolDay schoolDay = new SchoolDay("Friday", lessonsList);
                ...
                Intent intent = new Intent(SchoolFriday.this, SignInUserSunday.class);
