...
public class SchoolThursday extends AppCompatActivity {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (lessonsList.isEmpty()) {
                    Toast.makeText(SchoolThursday.this, "No lessons entered!", Toast.LENGTH_SHORT).show();
                    return;
                }

                String dayName = txtDayTitle.getText().toString();
                SchoolDay schoolDay = new SchoolDay("Thursday", lessonsList);
                ...
                Intent intent = new Intent(SchoolThursday.this, SchoolFriday.class);
